...
local addSelf = function()
  ...
  print(vim.inspect(lazya))
  print(vim.inspect(lazy.stats()))
  print(vim.inspect(lazy.stats().plugins))
  --print("Not loaded plugins:")
  --for _, plugin in ipairs(stats.plugins) do
    ...
    config = function()
      ...
      mason_tool_installer.setup({
        ensure_installed = {
          ...
          "buf", -- protobuf formater
          "yamlfix", -- yaml formater
          "taplo", -- toml formater
          "shellcheck", -- ShellCheck, a static analysis tool for shell scripts.
          "gopls", -- Go language server developed by the Go team.
