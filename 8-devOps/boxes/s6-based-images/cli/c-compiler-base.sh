...
buildah copy $container provision-c-compiler-base.yml
...
buildah run $container -- .venv/bin/ansible-playbook provision-c-compiler-base.yml
...
buildah run $container -- rm -rf /home/app/provision-c-compiler-base.yml
...
buildah commit $container $DOCKER_REGISTRY_PREFIX/ubuntu-c-compiler-base:latest
buildah push $DOCKER_REGISTRY_PREFIX/ubuntu-c-compiler-base:latest
