...
install_bruno() {
  ...
  cd "$TMP_DIR/$app_name"
  url1=$(curl -H "Authorization: Bearer $GITHUB_TOKEN" -H "Accept: application/vnd.github+json" -s https://api.github.com/repos/usebruno/bruno/releases/latest |
  ...
  mv bruno*x86_64_linux.AppImage bruno.AppImage
