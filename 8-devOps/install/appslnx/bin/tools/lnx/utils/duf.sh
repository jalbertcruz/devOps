...
install_duf() {
  ...
  cd "$TMP_DIR/$app_name"
  url=$(curl -H "Authorization: Bearer $GITHUB_TOKEN" -H "Accept: application/vnd.github+json" -s https://api.github.com/repos/muesli/duf/releases/latest |
  ...
  tar -xvf duf*linux_x86_64.tar.gz
