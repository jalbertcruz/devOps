...
install_yamlfmt() {
  ...
  cd "$TMP_DIR/$app_name"
  url=$(curl -H "Authorization: Bearer $GITHUB_TOKEN" -H "Accept: application/vnd.github+json" -s https://api.github.com/repos/google/yamlfmt/releases/latest |
  ...
  tar -xvf yamlfmt*inux_x86_64.tar.gz
