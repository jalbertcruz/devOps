...
install_lazygit() {
  ...
  cd "$TMP_DIR/$app_name"
  url=$(curl -H "Authorization: Bearer $GITHUB_TOKEN" -H "Accept: application/vnd.github+json" -s https://api.github.com/repos/jesseduffield/lazygit/releases/latest |
  ...
  tar -xvf lazygit_*inux_x86_64.tar.gz
