...
install_grpcurl() {
  ...
  cd "$TMP_DIR/$app_name"
  url=$(curl -H "Authorization: Bearer $GITHUB_TOKEN" -H "Accept: application/vnd.github+json" -s https://api.github.com/repos/fullstorydev/grpcurl/releases/latest |
  ...
  tar -xvf grpcurl*inux_x86_64.tar.gz
  mv grpcurl $DEST
