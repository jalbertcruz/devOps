...
** early init
#+begin_src emacs-lisp :tanglet ~/.config/emacs-dev-lsp/early-init.el
...
(setq package-archives '(
                         ...
                         ; here orderless new release appears first
...
#+end_src
** lsp bridge mark
#+name: lsp-bridge-mark
#+begin_src emacs-lisp
(setq lsp-mark 'emacsd-bridge)
#+end_src

** custom commands general
#+name: custom-commands-general
#+begin_src emacs-lisp
;;;; DEFUNS
...
#+name: where-buffers-are-displayed
#+begin_src emacs-lisp
...
; now works the multiserver config
(setq lsp-bridge-elixir-lsp-server nil)
...
#+name: lsp-bridge
#+begin_src emacs-lisp
(add-to-list 'load-path (concat user-home-directory "/src/emacs/packages-src/lsp-bridge/"))
(require 'lsp-bridge)

; this shows the json lsp messages in the *lsp-bridge* buffer
...
(use-package breadcrumb
  ...
  ;; Optionally, if you use which-func-mode, you can integrate with it
  ;; (setq which-func-functions #' (breadcrumb-imenu-crumbs))
  )

(setq header-line-format '( (:eval (breadcrumb-project-crumbs)) (:eval (breadcrumb-imenu-crumbs))))


; this do not work: "not in executable format: file format not recognized"
...
;;   :type 'string)
(setq lsp-bridge-python-lsp-server nil)
...
;; Do not forget to customize Combobulate to your liking:
  ...
  ;;
;; TODO: combo
(setq combobulate-path (concat user-home-directory "/src/emacs/packages-src/treesitter/combobulate/"))
...
(use-package combobulate
  ...
  ;; code.
  ;:load-path "/home/z/src/emacs/packages-src/treesitter/combobulate/"
...
#+end_src
** generation
#+begin_src emacs-lisp :tangle ~/.config/emacs-dev-bridge/init.el :noweb yes
<<core>>
#+end_src
#+begin_src emacs-lisp :tangle ~/.config/emacs-dev-lsp/init.el :noweb yes
<<core>>
#+end_src
#+begin_src emacs-lisp :tangle ~/.config/emacs-dev-eglot/init.el :noweb yes
<<core>>
#+end_src
#+begin_src emacs-lisp :tangle ~/.config/emacs-writer/init.el :noweb yes
<<core>>
#+end_src
#+begin_src emacs-lisp :tangle ~/.config/emacs-dev-bridge/init.el :noweb yes
<<custom-commands-general>>
...
<<custom-commands-general>>
#+end_src
#+begin_src emacs-lisp :tangle  (select-org-babel-destination "/tmp/init.el" "~/.config/emacs-dev-bridge/init.el") :noweb yes
<<package-internet>>
#+end_src
#+begin_src emacs-lisp :tangle  (select-org-babel-destination "/tmp/init.el" "~/.config/emacs-dev-lsp/init.el") :noweb yes
<<package-internet>>
#+end_src
#+begin_src emacs-lisp :tangle  (select-org-babel-destination "/tmp/init.el" "~/.config/emacs-dev-eglot/init.el") :noweb yes
<<package-internet>>
#+end_src
#+begin_src emacs-lisp :tangle  (select-org-babel-destination "/tmp/init.el" "~/.config/emacs-writer/init.el") :noweb yes
<<package-internet>>
#+end_src
#+begin_src emacs-lisp :tangle (select-org-babel-destination "~/.config/emacs-dev-bridge/init.el" "/tmp/init.el") :noweb yes
<<package-local>>
#+end_src
#+begin_src emacs-lisp :tangle (select-org-babel-destination "~/.config/emacs-dev-lsp/init.el" "/tmp/init.el") :noweb yes
<<package-local>>
#+end_src
#+begin_src emacs-lisp :tangle (select-org-babel-destination "~/.config/emacs-dev-eglot/init.el" "/tmp/init.el") :noweb yes
<<package-local>>
#+end_src
#+begin_src emacs-lisp :tangle (select-org-babel-destination "~/.config/emacs-writer/init.el" "/tmp/init.el") :noweb yes
<<package-local>>
#+end_src
#+begin_src emacs-lisp :tangle ~/.config/emacs-dev-bridge/init.el :noweb yes
<<package-initialize>>
