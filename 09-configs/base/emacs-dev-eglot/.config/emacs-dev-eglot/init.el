...
(use-package eglot
  ...
  (setf (alist-get '(elixir-mode elixir-ts-mode heex-ts-mode)
                   ...
                   nil nil #'equal)
        (eglot-alternatives (list (list (concat user-home-directory "/src/elixir/ex_packages/expert/apps/expert/_build/prod/rel/plain/bin/start_expert") "--stdio")))
